      ...
      <div class="form-block mt-10 grid grid-cols-5 gap-5">
        ...
        <div class="date-picker-wrap" >
          ...
          <div class="relative">
            ...
            <input ref="dateEndPicker" type="text" id="date-end" class="  mt-2
                  h-14
                  focus:ring-heliotrope focus:border-heliotrope
                  font-medium
                  block
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const datepickerEndEl = dateEndPicker.value;
    ...
    function onFileChange(e) {
      ...
      const item = images.value.find((el) => !el.image);
